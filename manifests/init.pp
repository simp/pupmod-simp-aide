...
class aide (
  ...
  Optional[Simplib::Cron::Minute]          $minute            = undef,
  Optional[Simplib::Cron::Hour]            $hour              = undef,
  Optional[Simplib::Cron::Monthday]        $monthday          = undef,
  Optional[Simplib::Cron::Month]           $month             = undef,
  Optional[Simplib::Cron::Weekday]         $weekday           = undef,
  Optional[Enum['root', 'etc', 'systemd']] $cron_method       = undef,
  Optional[String[1]]                      $systemd_calendar  = undef,
  Optional[String[1]]                      $cron_command      = undef,
